...
function useForkRef(...refs) {
  ...
  const refEffect = React18.useCallback((instance2) => {
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React42.useMemo(() => ({
...
var DrawingContext = React43.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React43.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React43.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React43.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React43.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
var SeriesContext = React44.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
var PluginContext = React45.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function wiggle_default(series, order3) {
  if (!((n = series.length) > 0) || !((m = (s0 = series[order3[0]]).length) > 0)) return;
...
function PluginProvider(props) {
  ...
  const formattedSeries = React46.useMemo(() => ({
    isInitialized: true,
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React53.useMemo(() => ({
    isInitialized: true,
...
var InteractionContext = React54.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React54.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React54.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function hslConvert(o) {
  ...
  if (s2) {
    if (r2 === max4) h = (g - b) / s2 + (g < b) * 6;
    else if (g === max4) h = (b - r2) / s2 + 2;
    else h = (r2 - g) / s2 + 4;
...
function useDrawingArea() {
  const {
    ...
    right: right3,
    isPointInside
  } = React56.useContext(DrawingContext);
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React57.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React57.useMemo(() => series.pie, [series.pie]);
}

// node_modules/@mui/x-charts/context/CartesianProvider/CartesianContext.js
var React58 = __toESM(require_react());
var CartesianContext = React58.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
function CartesianProvider(props) {
  ...
  const xValues = React59.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React59.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
  ...
  return (0, import_jsx_runtime22.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React62.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React63.forwardRef(function ChartsSurface2(inProps, ref) {
...
function useChartId() {
  ...
  return React64.useMemo(() => chartId, [chartId]);
}
...
var ZAxisContext = React65.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React65.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime25.jsxs)(React67.Fragment, {
...
function useChartGradient() {
  ...
  return React69.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var HighlightedContext = React70.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React71.useMemo(() => {
  ...
  const providerValue = React71.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
  ...
  return (0, import_jsx_runtime28.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React72.useContext(HighlightedContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React73.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React73.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var AnimationContext = React75.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React78.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime29.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React79.useContext(AnimationContext);
  if (!isInitialized) {
...
var ChartContainer = React80.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime30.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime30.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime30.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime30.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
            ...
            children: (0, import_jsx_runtime30.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime30.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime30.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime30.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime30.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const [width2, setWidth] = React81.useState(0);
  const [height2, setHeight] = React81.useState(0);
  const computeSize = React81.useCallback(() => {
...
var ResponsiveChartContainer = React82.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React83.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime32.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime32.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types26.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types26.default.bool,
   ...
   * Text displayed.
   */
  text: import_prop_types26.default.string.isRequired
} : void 0;
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime33.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime33.jsx)(Line, _extends({
      x1: left3,
      x2: left3 + width2,
      ...
      return (0, import_jsx_runtime33.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime33.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime33.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime33.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime33.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime34.jsxs)(YAxisRoot, {
    transform: `translate(${position3 === "right" ? left3 + width2 : left3}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime34.jsx)(Line, _extends({
      y1: top3,
      y2: top3 + height2,
      className: classes.line
      ...
      return (0, import_jsx_runtime34.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime34.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime34.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime34.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime34.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React87.Fragment, {
    children: [topId && (0, import_jsx_runtime35.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime35.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime35.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime35.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types29.default.oneOfType([import_prop_types29.default.object, import_prop_types29.default.string]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types29.default.oneOfType([import_prop_types29.default.object, import_prop_types29.default.string]),
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types29.default.oneOfType([import_prop_types29.default.object, import_prop_types29.default.string]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default null
   */
  topAxis: import_prop_types29.default.oneOfType([import_prop_types29.default.object, import_prop_types29.default.string])
} : void 0;
...
var Portal = React88.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React88.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React88.isValidElement(children)) {
      const newProps = {
        ref: handleRef
      };
      return React88.cloneElement(children, newProps);
    }
    return children;
  }
...
var PopperTooltip = React89.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React89.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React89.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React89.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React89.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React89.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React89.useState(resolveAnchorEl(anchorEl));
  React89.useEffect(() => {
  ...
  return (0, import_jsx_runtime36.jsx)(Root, {
    ...rootProps,
    children: typeof children === "function" ? children(childProps) : children
  });
});
var Popper = React89.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  return (0, import_jsx_runtime36.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime36.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime37.jsx)(GlobalStyles_default, {
    ...props,
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  });
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime39.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types33.default.object.isRequired
} : void 0;
...
var Popper3 = React93.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React95.useState(null);
  React95.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime41.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime41.jsx)("tbody", {
        children: (0, import_jsx_runtime41.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime41.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime41.jsx)(ChartsTooltipMark, {
              color: color3,
              className: classes.mark
            })
          }), (0, import_jsx_runtime41.jsx)(ChartsTooltipCell, {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React97.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime42.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
var Typography = React98.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
  ...
  return (0, import_jsx_runtime43.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime44.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime44.jsx)("thead", {
        children: (0, import_jsx_runtime44.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
            colSpan: 3,
      ...
      }), (0, import_jsx_runtime44.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime44.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime44.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime44.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types38.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types38.default.shape({
    x: import_prop_types38.default.shape({
      index: import_prop_types38.default.number,
      value: import_prop_types38.default.oneOfType([import_prop_types38.default.instanceOf(Date), import_prop_types38.default.number, import_prop_types38.default.string]).isRequired
    }),
    y: import_prop_types38.default.shape({
      index: import_prop_types38.default.number,
      value: import_prop_types38.default.oneOfType([import_prop_types38.default.instanceOf(Date), import_prop_types38.default.number, import_prop_types38.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types38.default.oneOfType([import_prop_types38.default.instanceOf(Date), import_prop_types38.default.number, import_prop_types38.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React100.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React100.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React100.useMemo(() => {
  ...
  return (0, import_jsx_runtime45.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime46.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime46.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime46.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime46.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime47.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime47.jsx)("rect", {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme5();
  const drawingArea = useDrawingArea();
  const labelStyle = React105.useMemo(
  ...
  const padding2 = React105.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React105.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React105.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React105.useMemo(() => {
  ...
  return (0, import_jsx_runtime48.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime48.jsx)(ChartsLegendRoot, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  drawingArea: import_prop_types40.default.shape({
    bottom: import_prop_types40.default.number.isRequired,
    height: import_prop_types40.default.number.isRequired,
    left: import_prop_types40.default.number.isRequired,
    right: import_prop_types40.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types40.default.arrayOf(import_prop_types40.default.shape({
    ...
    itemId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]),
    label: import_prop_types40.default.string.isRequired,
    maxValue: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]),
    minValue: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]),
    seriesId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string])
  })).isRequired
} : void 0;
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime50.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
true ? ChartsLegend.propTypes = {
   ...
   * @default 10
   */
  itemGap: import_prop_types41.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types41.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types41.default.number,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types41.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   * @param {SeriesLegendItemContext} legendItem The legend item data.
   ...
   * @default 10
   */
  padding: import_prop_types41.default.oneOfType([import_prop_types41.default.number, import_prop_types41.default.shape({
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React109.Fragment, {
    children: [(0, import_jsx_runtime51.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime51.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime51.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types42.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types42.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types43.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types43.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types43.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types43.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React111.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime53.jsxs)(React111.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime53.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime53.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime53.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime53.jsx)(ChartsAxisHighlightPath, {
...
var useInteractionItemProps = (skip) => {
  ...
  } = React112.useContext(InteractionContext);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
   ...
   */
  highlightScope: import_prop_types45.default.shape({
    fade: import_prop_types45.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types45.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types45.default.oneOf(["item", "none", "series"]),
    highlighted: import_prop_types45.default.oneOf(["item", "none", "series"])
  }),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React114.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime55.jsx)("g", _extends({}, other, {
    children: transition(({
      ...
      return (0, import_jsx_runtime55.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (
    // @ts-expect-error
    (0, import_jsx_runtime56.jsx)(PieArcLabelRoot, _extends({
      className: classes.root
    }, other, {
      style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  color: import_prop_types47.default.string.isRequired,
  formattedArcLabel: import_prop_types47.default.string,
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime57.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime57.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types48.default.oneOfType([import_prop_types48.default.oneOf(["formattedValue", "label", "value"]), import_prop_types48.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types48.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types48.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types48.default.number,
  data: import_prop_types48.default.arrayOf(import_prop_types48.default.shape({
    color: import_prop_types48.default.string.isRequired,
    endAngle: import_prop_types48.default.number.isRequired,
    formattedValue: import_prop_types48.default.string.isRequired,
    ...
    label: import_prop_types48.default.oneOfType([import_prop_types48.default.func, import_prop_types48.default.string]),
    padAngle: import_prop_types48.default.number.isRequired,
    startAngle: import_prop_types48.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types48.default.shape({
    additionalRadius: import_prop_types48.default.number,
    arcLabelRadius: import_prop_types48.default.number,
    color: import_prop_types48.default.string,
    cornerRadius: import_prop_types48.default.number,
    innerRadius: import_prop_types48.default.number,
    outerRadius: import_prop_types48.default.number,
    paddingAngle: import_prop_types48.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types48.default.shape({
    additionalRadius: import_prop_types48.default.number,
    arcLabelRadius: import_prop_types48.default.number,
    color: import_prop_types48.default.string,
    cornerRadius: import_prop_types48.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types48.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width: width2,
    height: height2
  } = React118.useContext(DrawingContext);
  ...
  return (0, import_jsx_runtime58.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime58.jsx)("g", {
        ...
        children: (0, import_jsx_runtime58.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime58.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime58.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(StyledText, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime60.jsx)(StyledText2, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime61.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime61.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var PieChart = React122.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiPieChart"
  });
...
true ? PieChart.propTypes = {
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types50.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
